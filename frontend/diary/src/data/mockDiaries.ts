...
// 型定義を再エクスポート
export type { DiaryEntry } from '../types';
...
export const mockDiaries: DiaryEntry[] = [
  ...
  },
  {
    ...
    createdAt: '2024-12-05T19:45:00Z'
  },
  {
    id: '7',
    date: '2024-12-03',
    ...
    createdAt: '2024-12-03T22:10:00Z'
  },
  {
    id: '8',
    date: '2024-12-01',
...
// 日記が存在する日付の配列を取得する関数
export const getDiaryDates = (): string[] => {
  return mockDiaries.map(diary => diary.date);
};

// 特定の日付の日記を取得する関数
export const getDiariesByDate = (date: string): DiaryEntry[] => {
